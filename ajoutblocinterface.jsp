...
<div class="page-container">
  ...
  <div class="sidebar collapse">
    ...
    <ul class="navigation">
     ...
     <li><a href="#" class="expand"><span>Employés</span> <i class="icon-user"></i></a>
          <ul>
            <li><a href="ajoutpersonnel.jsp">Ajout personnel</a></li>
            <li><a href="listPers.jsp">	   liste  des Personnels </a></li>
          </ul>
        </li>
            <li><a href="#" class="expand"><span> administrateurs</span> <i class="icon-table2"></i></a>
          <ul>
 ...
 <li><a href="#" class="expand"><span>Services</span> <i class="icon-numbered-list"></i></a>
          <ul>
 ...
 <li><a href="#" class="expand"><span>Contrats</span> <i class="icon-copy"></i></a>
          <ul>
            <li><a href="ajoutcontratinterface.jsp">Ajout  contrat </a></li>
            <li><a href="listcontrat.jsp">liste des contrats  </a></li>
          </ul>
        </li>
                 <li><a href="#" class="expand"><span>Congés</span> <i class="icon-stack"></i></a>
          <ul>
            <li><a href="FormCong.jsp">Ajouter un congé</a></li>
            <li><a href="listCong.jsp" >Liste des congés</a>
              </li>
              </ul> </li>
